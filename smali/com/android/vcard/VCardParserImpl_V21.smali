...
.method private getQuotedPrintablePart(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v4, "File ended during parsing a Quoted-Printable String"
...
.method private handleAdrOrgN(Lcom/android/vcard/VCardProperty;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v14, v0, Lcom/android/vcard/VCardParserImpl_V21;->mCurrentEncoding:Ljava/lang/String;

    const-string/jumbo v15, "QUOTED-PRINTABLE"
    ...
    invoke-virtual {v0, v7}, Lcom/android/vcard/VCardProperty;->setRawValue(Ljava/lang/String;)V
    ...
    invoke-static {v7, v14}, Lcom/android/vcard/VCardUtils;->constructListFromValue(Ljava/lang/String;I)Ljava/util/List;

    move-result-object v10

    .line 717
    .local v10, "quotedPrintableValueList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    invoke-interface {v10}, Ljava/lang/Iterable;->iterator()Ljava/util/Iterator;

    move-result-object v9

    .local v9, "quotedPrintableValue$iterator":Ljava/util/Iterator;
    :goto_0
    ...
    invoke-static {v8, v14, v0, v1}, Lcom/android/vcard/VCardUtils;->parseQuotedPrintable(Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .end local v9    # "quotedPrintableValue$iterator":Ljava/util/Iterator;
    .end local v10    # "quotedPrintableValueList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_0
    move-object/from16 v0, p0
    ...
    invoke-static {v6, v14}, Lcom/android/vcard/VCardUtils;->constructListFromValue(Ljava/lang/String;I)Ljava/util/List;
    ...
    .end local v12    # "value$iterator":Ljava/util/Iterator;
    .end local v13    # "valueList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_1
    move-object/from16 v0, p1

    invoke-virtual {v0, v3}, Lcom/android/vcard/VCardProperty;->setValues(Ljava/util/List;)V

    .line 733
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/vcard/VCardParserImpl_V21;->mInterpreterList:Ljava/util/List;

    invoke-interface {v14}, Ljava/lang/Iterable;->iterator()Ljava/util/Iterator;

    move-result-object v5

    .local v5, "interpreter$iterator":Ljava/util/Iterator;
    :goto_2
    ...
    check-cast v4, Lcom/android/vcard/VCardInterpreter;

    .line 734
    .local v4, "interpreter":Lcom/android/vcard/VCardInterpreter;
    move-object/from16 v0, p1

    invoke-interface {v4, v0}, Lcom/android/vcard/VCardInterpreter;->onPropertyCreated(Lcom/android/vcard/VCardProperty;)V

    goto :goto_2

    .line 699
    .end local v4    # "interpreter":Lcom/android/vcard/VCardInterpreter;
    :cond_2
    return-void
.end method
...
.method private handleNest()V
    ...
    .local v1, "interpreter$iterator":Ljava/util/Iterator;
    :goto_0
...
.method private parseItemInter(Lcom/android/vcard/VCardProperty;Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "Unknown property name: \""
...
.method private parseOneVCard()Z
    ...
    .local v2, "interpreter$iterator":Ljava/util/Iterator;
    :goto_0
...
.method protected constructPropertyData(Ljava/lang/String;)Lcom/android/vcard/VCardProperty;
    ...
    const-string/jumbo v9, "Empty group found. Ignoring."
    ...
    const-string/jumbo v9, "Double-quoted params found in vCard 2.1. Silently allow it"
    ...
    const-string/jumbo v10, "Invalid line: \""
...
.method protected getBase64(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v4, "File ended during parsing BASE64 binary"
    ...
    const-string/jumbo v4, "Found a next property during parsing a BASE64 string, which must not contain semi-colon or colon. Treat the line as next property."
    ...
    const-string/jumbo v5, "Problematic line: "
...
.method protected getNonEmptyLine()Ljava/lang/String;
    ...
    const-string/jumbo v2, "Reached end of buffer."
...
.method protected handleAgent(Lcom/android/vcard/VCardProperty;)V
    ...
    .line 922
    .end local v1    # "interpreter$iterator":Ljava/util/Iterator;
    :cond_1
    new-instance v2, Lcom/android/vcard/exception/VCardAgentNotSupportedException;

    const-string/jumbo v3, "AGENT Property is not supported now."
...
.method protected handleLanguage(Lcom/android/vcard/VCardProperty;Ljava/lang/String;)V
    ...
    const-string/jumbo v6, "Invalid Language: \""
...
.method protected handlePropertyValue(Lcom/android/vcard/VCardProperty;Ljava/lang/String;)V
    ...
    .local v10, "interpreter$iterator":Ljava/util/Iterator;
    :goto_1
    ...
    .end local v10    # "interpreter$iterator":Ljava/util/Iterator;
    ...
    .restart local v10    # "interpreter$iterator":Ljava/util/Iterator;
    :goto_2
    invoke-interface {v10}, Ljava/util/Iterator;->hasNext()Z
    ...
    .line 620
    .restart local v9    # "interpreter":Lcom/android/vcard/VCardInterpreter;
    move-object/from16 v0, p1
    ...
    const-string/jumbo v20, "vCard"

    const-string/jumbo v21, "OutOfMemoryError happened during parsing BASE64 data!"
    ...
    const-string/jumbo v22, "Decode error on base64 photo: "
    ...
    .line 632
    const-string/jumbo v21, "The encoding \"%s\" is unsupported by vCard %s"
    ...
    .line 670
    const-string/jumbo v20, "END:VCARD"
    ...
    .line 671
    .restart local v11    # "nextLine":Ljava/lang/String;
    :cond_c
...
.method protected handleType(Lcom/android/vcard/VCardProperty;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "TYPE unsupported by %s: "
...
.method protected handleValue(Lcom/android/vcard/VCardProperty;Ljava/lang/String;)V
    ...
    .line 497
    const-string/jumbo v2, "The value unsupported by TYPE of %s: "
...
.method protected isValidPropertyName(Ljava/lang/String;)Z
    ...
    const-string/jumbo v3, "Property name unsupported by vCard 2.1: "
...
.method public parse(Ljava/io/InputStream;)V
    ...
    const-string/jumbo v6, "InputStream must not be null."
    ...
    const-string/jumbo v6, "Cancel request has come. exitting parse operation."
...
.method protected parseItem()Z
    ...
    const-string/jumbo v6, "Unknown BEGIN type: "
    ...
    const-string/jumbo v6, "Unknown END type: "
...
.method protected readBeginVCard(Z)Z
    ...
    const-string/jumbo v5, "Expected String \"BEGIN:VCARD\" did not come (Instead, \""
    ...
    const-string/jumbo v4, "Reached where must not be reached."
